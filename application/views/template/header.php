...
<?php else: ?> 
    ...
    <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url();?>direktur/dashboard">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span></a>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Menu :</h6>
                        <a class="collapse-item" href="<?php echo site_url();?>direktur/hasilsurvey">Hasil Kuesioner</a>
                        <a class="collapse-item" href="<?php echo site_url();?>direktur/servperf">Analisis Serperv</a>
                    </div>
                </div>
            </li>
